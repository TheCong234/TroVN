...
const UserService = {
  ...
  async getUserByZaloId(zaloId, data) {
    try {
      return await UserModel.methods.getUserByZaloId(zaloId, data);
    } catch (error) {
      logger.error(error);
      throw error;
    }
  ...
  async sendEmailVerify(user) {
    try {
      ...
      const { id } = user;
      const { email } = await UserModel.methods.getUserById(id);
  ...
  async getUserIdsByRole(role) {
    try {
      return await UserModel.methods.getUserIdsByRole(role);
    } catch (error) {
      logger.error(error);
      throw error;
    }
  ...
  async getAllUserIds() {
    try {
      return await UserModel.methods.getAllUserIds();
    } catch (error) {
      logger.error(error);
      throw error;
    }
  ...
  async getBalance(userId) {
    try {
      return await UserModel.methods.getBalance(userId);
    } catch (error) {
      logger.error(error);
      throw error;
    }
